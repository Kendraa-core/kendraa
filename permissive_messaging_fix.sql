-- Permissive Messaging Fix Script
-- This script creates more permissive RLS policies to fix permission denied errors
...
-- Step 2: Create permissive policies that allow broader access
-- Conversation participants - allow users to see all participants in conversations they're part of
...
-- Messages - allow users to see messages in conversations they participate in
...
-- Conversations - allow users to see conversations they participate in
...
-- Success message
SELECT 'Permissive messaging policies created successfully!' as status;
