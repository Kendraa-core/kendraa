  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="flex">
        ...
        {/* Main Content */}
        <main className={`flex-1 ${shouldShowSidebars ? 'lg:ml-64' : ''} ${shouldShowInnovativeSidebar ? 'lg:mr-80' : ''}`}>
          <div className="min-h-screen">
            {children}
          </div>
        </main>
        
        {/* Innovative Sidebar for Feed Page */}
        {shouldShowInnovativeSidebar && (
          <div className="hidden lg:block fixed right-0 top-16 w-80 h-[calc(100vh-4rem)] bg-gradient-to-b from-[#007fff]/5 to-[#007fff]/10 border-l border-[#007fff]/20 overflow-y-auto">
